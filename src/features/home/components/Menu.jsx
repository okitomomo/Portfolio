    ...
    return (
        <nav className="flex flex-col md:flex-row font-eng min-h-[470px]">
            ...
            <HashLink smooth to="#about-this" className="group relative flex flex-1 cursor-pointer"> 
                <div className="absolute inset-0 bg-[url('img/header_01.jpg')] bg-cover bg-left grayscale brightness-[15%] group-hover:brightness-100 transition-all duration-300"></div>
            ...
            <HashLink smooth to="#about-me" className="group relative flex flex-1 cursor-pointer">
                <div className="absolute inset-0 bg-[url('img/header_02.jpg')] bg-cover bg-[center_25%] md:bg-[50%_center] grayscale brightness-[15%] group-hover:brightness-100 transition-all duration-300"></div>
                <div className="md:absolute bottom-20 z-10 flex w-full flex-row md:flex-col items-center group-hover:text-stroke">
            ...
            <HashLink smooth to="#skill-set" className="group relative flex flex-1 cursor-pointer">
                <div className="absolute inset-0 bg-[url('img/header_03.jpg')] bg-cover bg-[40%_center] grayscale brightness-[15%] group-hover:brightness-100 transition-all duration-300"></div>
                <div className="md:absolute bottom-20 z-10 flex w-full flex-row md:flex-col items-center group-hover:text-stroke">
            ...
            <HashLink smooth to="#production" className="group relative flex flex-1 cursor-pointer">
                <div className="absolute inset-0 bg-[url('img/header_04.jpg')] bg-cover bg-[45%_center] grayscale brightness-[15%] group-hover:brightness-100 transition-all duration-300"></div>
                <div className="md:absolute bottom-20 z-10 flex w-full flex-row md:flex-col items-center group-hover:text-stroke">
            ...
            <HashLink smooth to="#qualification" className="group relative flex flex-1 cursor-pointer">
                <div className="absolute inset-0 bg-[url('img/header_05.jpg')] bg-cover bg-[40%_center] grayscale brightness-[15%] group-hover:brightness-100 transition-all duration-300"></div>
                <div className="md:absolute bottom-20 z-10 flex w-full flex-row md:flex-col items-center group-hover:text-stroke">
            ...
            <HashLink smooth to="#workhistory" className="group relative flex flex-1 cursor-pointer">
                <div className="absolute inset-0 bg-[url('img/header_06.png')] bg-cover bg-[center_65%] md:bg-[40%_center] grayscale brightness-[15%] group-hover:brightness-100 transition-all duration-300"></div>
                <div className="md:absolute bottom-20 z-10 flex w-full flex-row md:flex-col items-center group-hover:text-stroke">
            ...
            <HashLink smooth to="#my-life" className="group relative flex flex-1 cursor-pointer">
                <div className="absolute inset-0 bg-[url('img/header_07.jpg')] bg-cover bg-[center_65%] md:bg-[60%_center] grayscale brightness-[15%] group-hover:brightness-100 transition-all duration-300"></div>
                <div className="md:absolute bottom-20 z-10 flex w-full flex-row md:flex-col items-center group-hover:text-stroke">
